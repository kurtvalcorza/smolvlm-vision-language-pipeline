...
- Local snapshot: `weights/smolvlm-500m-instruct/` with `dimer-base-manifest.json` (14 entries, per-file bytes + SHA-256, `totalBytes` 1019893574); the Git repository does not vendor the checkpoint.
