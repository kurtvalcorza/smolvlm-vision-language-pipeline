...
TEMPLATE = {
    ...
    "cells": [
        ...
        },
        {
            "md": (
                ...
                "**near the empty baseline**: the build record measured @P:FROZEN_CER@ (hypotheses @P:FROZEN_HYP_RATIO@ times "
        ...
        },
        {
            "md": (
                ...
                "record) while the loss drops from about @P:LOSS_1@ to @P:LOSS_LAST@: @P:ADAPTED_READ@. The two sibling "
    ...
    "closing": (
        ...
        "GOT-OCR 2.0 at 0.759 and Florence-2 at 0.797, both squashing the line into a square — @P:SIBLING_COMPARISON@.\n\n"
        ...
        "counting (@P:DRAWING_AFTER@), not a measurement, and a deployment that needs the other prompts must measure them "
