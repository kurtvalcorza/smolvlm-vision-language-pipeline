"""Static release-asset validation for the SmolVLM-500M-Instruct vision-language DIMER pipeline.
...
EXPECTED_MODEL_ID = "HuggingFaceTB/SmolVLM-500M-Instruct"
...
EXPECTED_OUTPUTS = (
    "outputs/smolvlm_vision_language_train.csv",
    "outputs/smolvlm_vision_language_example_line.png",
    "outputs/smolvlm_vision_language_input_manifest.json",
    "outputs/smolvlm_vision_language_evaluation_report.json",
    "outputs/smolvlm_vision_language_examples",
    "outputs/smolvlm_vision_language_adapter",
    "outputs/smolvlm_vision_language_result.json",
)
...
CODE_MARKERS = (
    ...
    "write_dataset_csv(train_records, 'outputs/smolvlm_vision_language_train.csv')",
    "validate_dataset(probe)",
    "print({'ceilings': {'MAX_IMAGES': MAX_IMAGES, 'MIN_IMAGE_SIDE': MIN_IMAGE_SIDE, 'MAX_IMAGE_SIDE': MAX_IMAGE_SIDE, 'MAX_IMAGE_PIXELS': MAX_IMAGE_PIXELS, 'MAX_TEXT_CHARS': MAX_TEXT_CHARS, 'MAX_NEW_TOKENS': MAX_NEW_TOKENS, 'DEFAULT_MAX_NEW_TOKENS': DEFAULT_MAX_NEW_TOKENS, 'DEFAULT_LINE_MAX_NEW_TOKENS': DEFAULT_LINE_MAX_NEW_TOKENS, 'DECODING': DECODING, 'TRANSCRIBE_PROMPT': TRANSCRIBE_PROMPT, 'MIN_RECORDS': MIN_RECORDS, 'MAX_RECORDS': MAX_RECORDS",
    ...
    "report = evaluation_report(answers, sample_kind=",
    ...
    "pipe.save_artifact(artifact_dir, metadata={'tutorial': 'smolvlm_vision_language', 'data_source': data_source})",
...
MARKDOWN_MARKERS = (
    "**Capability:** image + text to text generation (captioning and visual question answering) and bounded supervised fine-tuning of one instruction",
    "**Apache-2.0** licence",
    "**greedy** by default",
    "**generated text with no score**",
    "**adaptation of one instruction on transcribed lines**",
    ...
    "multi-image and multi-turn conversations (`MAX_IMAGES = 1`, one user turn)",
