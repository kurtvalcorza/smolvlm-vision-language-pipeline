...
EXPECTED_OUTPUTS = (
    ...
    "outputs/smolvlm_vision_language_answers.csv",
)
...
MARKDOWN_MARKERS = (
    ...
    "**no score and no correctness signal**",
    "**no reference answers**",
    "**always `not-measurable`**",
    "ships **no metric helper**",
    "reference captions for a caption metric such as CIDEr",
    "multi-image or video input (`MAX_IMAGES` = 1)",
    "`MAX_IMAGE_SIDE`",
    "`MAX_NEW_TOKENS`",
    "**Troubleshooting.**",
)
